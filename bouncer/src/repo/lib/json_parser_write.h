...
//This is a modified version of json_parser_write.h from boost v1_58 for the purpose
//of achieving a json writer that conforms to json standards (i.e. type enforcement)
//Altered for the purpose of 3D Repo Bouncer, not designed to work in a general case
			...
			std::basic_string<Ch> create_escapes(const std::basic_string<Ch> &s)
			{
				...
				while (b != e)
				{
					...
					if (c == 0x20 || c == 0x21 || (c >= 0x23 && c <= 0x2E) ||
						(c >= 0x30 && c <= 0x5B) || (c >= 0x5D && c <= 0xFF) || *b == Ch('"'))
						result += *b;
