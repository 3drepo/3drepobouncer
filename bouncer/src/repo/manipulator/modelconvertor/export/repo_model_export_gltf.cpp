...
static const std::string        REPO_GLTF_DEFAULT_SHADER_FRAG_URI = "/shader/gltfStockShaders/fragShader.glsl";
static const std::string        REPO_GLTF_DEFAULT_SHADER_VERT     = "default_vshader";
static const std::string        REPO_GLTF_DEFAULT_SHADER_VERT_URI = "/shader/gltfStockShaders/vertShader.glsl";
