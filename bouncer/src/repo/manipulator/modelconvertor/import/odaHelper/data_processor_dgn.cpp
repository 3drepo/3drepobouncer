...
void printTree(const boost::property_tree::ptree &tree,
	std::unordered_map<std::string, repo::lib::MetadataVariant> &resultCollector,
...
std::unordered_map<std::string, repo::lib::MetadataVariant> DataProcessorDgn::extractXMLLinkages(OdDgElementPtr pElm) {
	std::unordered_map<std::string, repo::lib::MetadataVariant> entries;
