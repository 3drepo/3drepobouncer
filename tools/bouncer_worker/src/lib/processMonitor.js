...
ProcessMonitor.sendReport = async (ridString) => {
	if (!(await ProcessMonitor.enabled) || !dataByModel[ridString]) return;
	const report = dataByModel[ridString];
