...
SET ODA_ROOT=C:\Dependencies\teigha_2024.8
SET ODA_LIB_DIR=C:\Dependencies\teigha_2024.8\lib\vc14_amd64dll
...
mkdir build
cd build
cmake -DREPO_BUILD_TESTS=ON -DODA_SUPPORT=ON -DSYNCHRO_SUPPORT=ON -DCMAKE_INSTALL_PREFIX="%CD%\install" -G "Visual Studio 16" -A x64 -T v140 ../
cd ..
