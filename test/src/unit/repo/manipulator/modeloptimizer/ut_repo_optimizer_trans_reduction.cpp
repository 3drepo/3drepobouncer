...
TEST(TransformationReductionOptimizer, ConstructorTest)
{
	TransformationReductionOptimizer();
}

TEST(TransformationReductionOptimizer, DeconstructorTest)
{
	auto ptr = new TransformationReductionOptimizer();
	delete ptr;
}

TEST(TransformationReductionOptimizer, ApplyOptimizationTest)
{
