...
TEST(ClashIfcExp, IfcExpDisjoint)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpDisjoint_Part";
	std::string postFix = ".ifc";
	...
	for (int i = 0; i < noParts; i++) {
		std::string fileName = baseName + std::to_string(i) + postFix;
		std::string path = "/clash/IFCExp/" + fileName;
...
TEST(ClashIfcExp, IfcExpIntersectClosed)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpIntersectClosed_Part";
	std::string postFix = ".ifc";
...
TEST(ClashIfcExp, IfcExpIntersectOpen)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpIntersectOpen_Part";
	std::string postFix = ".ifc";
...
TEST(ClashIfcExp, IfcExpCovers)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpCovers_Part";
	std::string postFix = ".ifc";
...
TEST(ClashIfcExp, IfcExpContains)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpContains_Part";
	std::string postFix = ".ifc";
...
TEST(ClashIfcExp, IfcExpMeet)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpMeet_Part";
	std::string postFix = ".ifc";
...
TEST(ClashIfcExp, IfcExpOverlap)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpOverlap_Part";
	std::string postFix = ".ifc";
...
TEST(ClashIfcExp, IfcExpEqual)
{
	...
	int totalSamples = 10000;
	int samplesPerSegment = totalSamples / noParts;
	std::string baseName = "ifcExpEqual_Part";
	std::string postFix = ".ifc";
